...
public class Waffle extends Producto implements Serializable{
	...
	public Waffle(String nombre, int precio, String sabor, String ingredientes, boolean tieneHelado,
			String saborHelado) {
	...
	public Waffle(String nombre, int precio, String sabor, String ingredientes) {
		super(nombre, precio, sabor, ingredientes);
		// TODO Auto-generated constructor stub
	}
	...
	public String toString() {
		return super.toString() + "Waffle: \nTiene Helado?: " + tieneHelado + 
