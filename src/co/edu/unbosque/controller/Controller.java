...
public class Controller implements ActionListener{
	...
	public void asignarListeners() {
		...
		vf.getVenMenu().getBtnInicio().addActionListener(this);
		vf.getVenMenu().getBtnInicio().setActionCommand("BOTON_INICIO");
		
		vf.getSel().getBtnVolver().addActionListener(this);
		vf.getSel().getBtnVolver().setActionCommand("BOTON_VOLVER");
